...
the project will come with the .godot file inside the project, that's just shaders, delete that entire folder and run godot again to rebuild if you are having graphical issues.
