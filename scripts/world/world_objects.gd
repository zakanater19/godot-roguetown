...
func handle_rpc_confirm_unequip(peer_id: int, slot_name: String, new_entity_id: String, hand_index: int) -> void:                         items.handle_rpc_confirm_unequip(peer_id, slot_name, new_entity_id, hand_index)
