...
func handle_rpc_confirm_equip(peer_id: int, item_id: String, slot_name: String, hand_index: int, item_type: String, slot_data: Dictionary) -> void: items.handle_rpc_confirm_equip(peer_id, item_id, slot_name, hand_index, item_type, slot_data)
...
func handle_rpc_confirm_unequip(peer_id: int, slot_name: String, new_entity_id: String, hand_index: int, item_type: String, slot_data: Dictionary) -> void: items.handle_rpc_confirm_unequip(peer_id, slot_name, new_entity_id, hand_index, item_type, slot_data)
func handle_rpc_request_furnace_action(sender_id: int, furnace_id: String, action: String, hand_idx: int) -> void:                        items.handle_rpc_request_furnace_action(sender_id, furnace_id, action, hand_idx)
func handle_rpc_confirm_furnace_action(peer_id: int, furnace_id: String, action: String, hand_idx: int, generated_ids: Array) -> void:    items.handle_rpc_confirm_furnace_action(peer_id, furnace_id, action, hand_idx, generated_ids)
func handle_rpc_request_torchwall_action(sender_id: int, torchwall_id: String, action: String, hand_idx: int) -> void:                    items.handle_rpc_request_torchwall_action(sender_id, torchwall_id, action, hand_idx)
func handle_rpc_confirm_torchwall_action(peer_id: int, torchwall_id: String, action: String, hand_idx: int, generated_ids: Array) -> void: items.handle_rpc_confirm_torchwall_action(peer_id, torchwall_id, action, hand_idx, generated_ids)
func handle_rpc_confirm_auto_extinguish_torch(torch_id: String) -> void:                                                                   items.handle_rpc_confirm_auto_extinguish_torch(torch_id)
...
func handle_rpc_request_combine_ground_coin(sender_id: int, coin_id: String, hand_idx: int) -> void:                                      coins.handle_rpc_request_combine_ground_coin(sender_id, coin_id, hand_idx)
func handle_rpc_confirm_combine_ground_coin(peer_id: int, coin_id: String, hand_idx: int, amount: int) -> void:                           coins.handle_rpc_confirm_combine_ground_coin(peer_id, coin_id, hand_idx, amount)
